...
- child components, sharing data with components - know what components to create
- re-rendering after filter, how to update the dom - organizing code right
- knowing where state should live, where to pass it through, what should be state
- sort/filter - having multiple states interact
- BONUS: adding new hogs!
- BONUS: CSS! working with Semantic UI
