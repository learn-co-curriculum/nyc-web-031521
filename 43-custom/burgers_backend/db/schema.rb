...
ActiveRecord::Schema.define(version: 2021_06_01_193558) do
  ...
  create_table "burger_orders", force: :cascade do |t|
    ...
    t.index ["burger_id"], name: "index_burger_orders_on_burger_id"
    t.index ["order_id"], name: "index_burger_orders_on_order_id"
  end
